...
public class AddInstr extends AbstractMachineInstruction {

	InstructionType type;
	BinaryOperatorNode binaryOperator;
	
	public AddInstr(BinaryOperatorNode binaryOperator, InstructionType type) {
	...
	public void execute(AbstractMachineFunction context, StackFrame frame) {
		...
		case _Ref -> throw new RuntimeException("Unsupported instruction type " + type + " for: Add");
		};
