...
public class DivInstr extends AbstractMachineInstruction {

	InstructionType type;
	BinaryOperatorNode binaryOperator;
	
	public DivInstr(BinaryOperatorNode binaryOperator, InstructionType type) {
	...
	public void execute(AbstractMachineFunction context, StackFrame frame) {
		...
		case _Ref -> throw new RuntimeException("Unsupported instruction type " + type + " for: Div");
		};
