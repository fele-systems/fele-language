...
public class LoadLInstr extends AbstractMachineInstruction {

	private final AbstractSyntaxTreeNode literalNode;
	private final InstructionType ldType;
	private int localIndex;

	public LoadLInstr(InstructionType ldType, AbstractSyntaxTreeNode literalNode, int localIndex) {
		this.ldType = ldType;
	...
	public void execute(AbstractMachineFunction context, StackFrame frame) {
		var local = frame.locals[localIndex];
